...
SECRET_KEY = '6@%)@mq(aqr36lp(0555!d@&@*_yjgkavb^s*3#17&5%ao@8%4'
...
# reference: https://github.com/rgs258/logging_in_django/blob/master/mysite/settings.py
...
CONSOLE_LOGGING_FILE_LOCATION = os.path.join(CONFIG_BASE_FILE.split(f'config{os.sep}settings')[0], 'camera-wrds.log')
...
LOGGING = {
    ...
    'filters': {
        ...
        'ignore_something': {
            '()': 'camera.logging_helpers.SomethingFilter',
        },
    },
    'formatters': {
        'my_formatter': {
            'format': CONSOLE_LOGGING_FORMAT,
            'class': 'camera.logging_helpers.HostnameAddingFormatter',
        },
    },
    'handlers': {
        'mail_admins': {
