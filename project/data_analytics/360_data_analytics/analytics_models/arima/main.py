...
class main:
    ...
    def mainArima(self):
        ...
        # For Windows
        # dataframe = panda.read_csv("~\Documents\Github\soen490_dev_env\project\360_data_analytics\\360_data_analytics\data_generator\\test.csv", index_col = ['date'], parse_dates = ['date'], encoding = 'utf-16', delimiter=";")
        # For Linux, the path depends on where the Github project is cloned
        dataframe = panda.read_csv("~/Soen490/project/360_data_analytics/360_data_analytics/data_generator/test.csv", index_col = ['date'], parse_dates = ['date'], delimiter=";")
